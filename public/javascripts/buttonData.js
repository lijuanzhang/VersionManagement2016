...
function checkDataForBtnSubmit() {
    ...
    switch (processStepId) {
        case "1":
            return checkDataForApplySubmit();
            break;
        case "0":
            return checkDataForApplySubmit();
            break;
        case "2":
            return checkDataForConfirmSubmit();
            break;
        case "3":
            return checkDataForDesignSubmit();
            break;
        case "4":
            return checkDataForDesConfirmSubmit();
            break;
...
function getDataForBtns(buttonName) {
    switch (buttonName) {
        case  "btnSubmit"  :
            return getDataForBtnSubmit();
            break;
        case  "btnUpload":
            return;
            break;
        case   "btnApply":
            return getDataForBtnApply();
            break;
        case   "btnNextDealer":
            return getDataForBtnNextDealer();
            break;
        case   "btnSetLeader":
            break;
        case   "btnDeleteReq" :
            return getDataForBtnDeleteReq();
            break;
        case   "btnAddRTime" :
            return getDataForBtnAddRTime();
            break;
    }
}
//btnSubmit 要提交的数据
