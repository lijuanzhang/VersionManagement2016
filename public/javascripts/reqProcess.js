...
function doAjaxSubmit(buttonName, params, url, subType) {
    switch (buttonName) {
        case  "btnSubmit"  :
            ajaxSubmit_submit(params, url, subType);
            break;
        case  "btnUpload":
            return;
            break;
        case  "btnApply":
            ajaxSubmit_apply(params, url, subType);
            break;
        case  "btnNextDealer":
            ajaxSubmit_nextDealer(params, url, subType);
            break;
        case  "btnSetLeader":
            break;
        case  "btnDeleteReq" :
            ajaxSubmit_delete(params, url, subType);
            break;
        case  "btnAddRTime" :
            ajaxSubmit_addRTime(params, url, subType);
            break;
    }
}
//绑定菜单的点击事件
