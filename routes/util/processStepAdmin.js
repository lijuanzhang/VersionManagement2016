...
function startAutoProcess(params, callback) {
    switch (params) {
        case 12:
            autoToDevReposity(params, callback);
            break;
        default :
            callback("err");
    }
...
function startProcess(params, callback) {
    ...
    switch (parseInt(params.processStepId)) {
        case 3:
            submitFileProcess(params, callback);
            break;
        case 4:
            planCheckProcess(params, callback);
            break;
        case 6:
            submitProcess(params, callback);
            break;
        case 8:
            testProcess(params, callback);
            break;//测试环节
        case 12:
            submitToDevProcess(params, callback);
            break;//上开发库环节
        case 13:
            submitToDevCompleteProcess(params, callback);
            break;//上开发库完成环节
    }
...
function endProcess(params, callback) {
    switch (params.processStepId) {
        case 2:
            ...
            break;
        case 3:
            endSubmitFileProcess(params, callback);
            break;
        case 4:
        ...
        case 12:
            endSubmitToDev(params, callback);
            break;
    }
