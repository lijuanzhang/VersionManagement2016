...
function startProcess(params, callback) {
    ...
    switch (parseInt(params.processStepId)) {
        case 1:
            newRDProcess(params, callback);
            break;
        case 2:
            confRDProcess(params, callback);
            break;
        case 3:
            desiRDProcess(params, callback);
            break;
        case 4:
            desConfirmRDProcess(params, callback);
            break;
        case 5:
            devRDProcss(params, callback);
            break;
...
function endProcess(params, callback) {
    ...
    switch (params.processStepId) {
        case "1":
            ...
            break;
        case "2":
            endConfRDProcess(params, callback);
            break;
        case "3":
            endDesiRDProcess(params, callback);
            break;
        case "4":
            endDesConfirmRDProcess(params, callback);
            break;
        case "5":
            endDevRDProcss(params, callback);
            break;
        //case "rd_6":
